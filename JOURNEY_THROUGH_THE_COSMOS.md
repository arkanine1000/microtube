...
4. **Capability saturation.** All 4 timbres, all 5 mist textures, the original Canon/Penrose spawn modes, both Shepard directions, all 6 visualisations are used. The brief was *make use of all program capabilities implemented at the time*, and I read that as art-as-inventory — every then-current dial of the instrument turned at least once. Fuxian mode is a later voice-leading addition, not part of this composition's original map.
